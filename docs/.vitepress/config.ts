...
export default defineConfig({
  ...
  vite: {
    plugins: [
      llmstxt({
        description:
          "Documentation for Atlas research cartography and API usage.",
        details:
          "Atlas helps structure scientific literature into queryable project data.",
      }),
    ],
  },
  themeConfig: {
    ...
    nav: [
      ...
      { text: "Open Atlas", link: "https://atlas.seas.upenn.edu/" },
    ],
    sidebar: [
      {
        text: "Introduction",
