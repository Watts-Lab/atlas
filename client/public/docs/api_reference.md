...
```json
{
  ...
  "project_features": [
    "64a1f2e3b4c5d6e7f8a9b0c5",
    "64a1f2e3b4c5d6e7f8a9b0c6"
  ]
}
```
...
{
  "result_ids": [
    "64a1f2e3b4c5d6e7f8a9b0c4",
    "64a1f2e3b4c5d6e7f8a9b0c8"
  ]
}
```
...
```json
{
  ...
  "task_ids": [
    "d3f1a2b4-9c8e-4f2a-b1d0-7e6f5a4b3c2d",
    "e4a9c3f1-2d8b-4e7f-a0c1-8b7d6e5f4a3b"
  ]
}
```
...
*Atlas API — © 2025 University of Pennsylvania. All rights reserved.*
```
